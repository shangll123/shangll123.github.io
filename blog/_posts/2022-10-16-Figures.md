...
- [increase point size in legends](#increase-point-size-in-legends)
...
- [line plot](#line-plot)
- [voronoi plot](#voronoi-plot)
- [heatmap](#heatmap)
- [heatmap change margin size and color](#heatmap-change-margin-size-and-color)
- [QQ plot](#qq-plot)
- [QQplot multiple groups](#qqplot-multiple-groups)
- [categorical value visualization on 2d](#categorical-value-visualization-on-2d)
- [continuous value visualization on 2d](#continuous-value-visualization-on-2d)
- [calculate Moran I](#calculate-moran-i)
- [string split code](#string-split-code)
- [testEnrichment](#testenrichment)
- [gprofiler2, GSEA](#gprofiler2-gsea)
- [tryCatch skip errors](#trycatch-skip-errors)
- [ZIP and unzip](#zip-and-unzip)
- [read in h5ad file](#read-in-h5ad-file)
- [plot 2d values with clusters](#plot-2d-values-with-clusters)
...
<img src="/assets/images/papers/color.png" alt="photo" width="600"/>
